...
if __name__ == '__main__':
    ...
    #quiver_data_plot(xx, yy, vel[2, :, :], vel[:2, :, :], 'Normalized z velocity', 'w/U', save=False)
    #quiver_data_plot(xx, yy, vel[2, :, :], vel[:2, :, :], 'Normalized z velocity', 'w/U', save=True)
    ...
    # quiver_data_plot(xx, yy, vel[0, :, :], u_grad, 'u', 'u/U', save=False)
